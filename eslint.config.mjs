...
export default withNuxt(
  ...
  {
    // Display block components that are intentionally single-word (design-spec names).
    files: ['app/features/forms/components/display/Divider.vue', 'app/features/forms/components/display/Spacer.vue'],
    rules: {
