// app/whitelabels/sportsquad/privacy.ts
// SportSquad Privacy Policy. Same platform-only posture as the Terms: SportSquad operates the
// technology; Organizers independently control the attendee data they collect, and payment data is
// handled by third-party processors — not by SportSquad.
//
...
export const privacy: LegalDocument = {
  ...
  intro: [
    ...
    `${BRAND} is a technology platform. When you buy a ticket or register for an event, the event organizer ("Organizer") also receives your information and decides how to use it as an independent controller. This Policy covers our own processing; it does not cover what an Organizer does with your data — for that, contact the Organizer.`,
  ],
  sections: [
    {
      heading: '1. Who is responsible for your data',
      paragraphs: [
        `${BRAND} is the controller of personal data processed to operate the Platform (for example, organizer accounts and Platform usage). For attendee data submitted through an event, the Organizer is an independent controller and is responsible for its own use of that data under its own privacy practices.`,
      ],
    },
    {
      ...
      bullets: [
        ...
        'Registration information you provide — such as name, email, and any details an event asks for (which may include date of birth or other fields the Organizer defines);',
        'Order and communication records — confirmations, receipts, and messages relating to your bookings;',
    ...
    },
    {
      ...
      bullets: [
        'provide, operate, and improve the Platform and process registrations and orders;',
    ...
    },
    {
      ...
      bullets: [
        'with the Organizer of an event you register for, who receives your registration data as an independent controller;',
    ...
    },
    {
      ...
      paragraphs: [
        `We keep personal data for as long as needed to provide the Platform, to comply with legal, tax, and accounting obligations, to resolve disputes, and to enforce our agreements. Organizers determine how long they keep the attendee data they control.`,
      ],
    },
    {
      heading: '10. Security',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `To exercise rights over data held by ${BRAND}, contact us at ${CONTACT_EMAIL}. For data held by an Organizer (such as your event registration details), please contact that Organizer directly, as they control that data.`,
      ],
    },
    {
      heading: '13. Children',
