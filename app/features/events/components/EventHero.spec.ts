...
function event(p: Partial<PublicEvent> = {}): PublicEvent {
  return {
    id: 1, series_id: null, type: null, title: 'Spring Gala', slug: 'spring-gala', year: 2026,
    description: null, details: null, location: 'Parish Hall', location_details: null,
    starts_at: '2026-04-05T23:00:00Z', ends_at: null, timezone: 'America/New_York',
    currency: 'USD', is_featured: false, visibility: 'public',
    cover: null, has_capacity: false, available_capacity: null, tickets: [], ...p,
  }
}
...
describe('EventHero', () => {
  ...
  it('renders the cover image when present', () => {
    const w = mount(EventHero, { props: { event: event({ cover: { id: 1, url: 'https://x/c.jpg' } }) } })
